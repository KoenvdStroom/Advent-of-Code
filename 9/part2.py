...
def move_tail(leader_position, tail_position):
  horizontal_distance = leader_position[0]-tail_position[0]
  vertical_distance = leader_position[1] - tail_position[1]
...
def main():
  ...
  for i in action_string:
    ...
    history.append(','.join(map(str, tail_positions[-1])))
  print(history)
